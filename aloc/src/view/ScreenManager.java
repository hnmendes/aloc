...
public class ScreenManager {
	...
	private void initialize() {
		...
		try {
			...
			this.setAddDisciplinaScene(new Scene(addDisciplinaPane));
			this.setAddDisciplinaController((AddDisciplinaCoordController) fxmlLoader.getController());
			
			fxmlLoader = new FXMLLoader();
			AnchorPane professorPane = fxmlLoader.load(getClass().getResource("/view/ProfessorFXML.fxml").openStream());
			this.setProfessorScene(new Scene(professorPane));
			this.setProfessorController((ProfessorController) fxmlLoader.getController());
	...
	public Scene getProfessorScene() {
		return professorScene;
	}

	public void setProfessorScene(Scene professorScene) {
		this.professorScene = professorScene;
	}
